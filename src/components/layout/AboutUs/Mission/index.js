      ...
      <section className={classes.Missions}>
        <div className={classes.Mission}>
          ...
          <div className={classes.Content}>
            <h3>Misión</h3>
            <p>Somos el startup financiero que revoluciona la forma de administrar el dinero a través de una plataforma 100% digital, sencilla, amigable y de confianza. Integrando a su vez la importancia de impulsar la educación financiera.</p>
          </div>
        </div>
        <div className={classes.Mission}>
          ...
          <div className={classes.Content}>
            <h3>Visión</h3>
            <p>Ser reconocidos en toda Latinoamérica como el primer startup financiero 100% digital que utiliza la última tecnología existente para poder ofrecer productos y servicios financieros innovadores, siendo además referentes de llevar un sistema de educación financiera.</p>
          </div>
        </div>
        <div className={classes.Mission}>
